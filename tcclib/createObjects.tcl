...
proc createConfig {name args} {
   ...
   if { [llength \
      [itcl::find  objects ::TcsConfigNames::$name -class ConfigComponent]] != 0} {
...
proc createScienceTarget {name args} {
   ...
   if { [llength \
      [itcl::find  objects ::ScienceTargetNames::$name -class TargetComponent]] != 0} {
...
proc createWfsTarget {name args} {
   ...
   if { [llength \
      [itcl::find  objects ::WfsTargetNames::$name -class TargetComponent]] != 0} {
...
proc createPointingOrigin {name args} {
   ...
   if { [llength \
      [itcl::find  objects ::PointOrigNames::$name -class PointOrigComponent]] != 0} {
...
proc createSlewOptions {name args} {
   ...
   if { [llength \
      [itcl::find  objects ::SlewOptionsNames::$name -class SlewOptionsComponent]] != 0} {
...
proc createTrackFrame {name args} {
   ...
   if { [llength \
      [itcl::find  objects ::TrackFrameNames::$name -class TrackFrameComponent]] != 0} {
...
proc createWavelength {name args} {
   ...
   if { [llength \
      [itcl::find  objects ::WavelengthNames::$name -class WavelengthComponent]] != 0} {
...
proc createInstrument {name args} {
   ...
   if { [llength \
      [itcl::find  objects ::InstrumentNames::$name -class InstrumentComponent]] != 0} {
...
proc createTrackRate {name args} {
   ...
   if { [llength \
      [itcl::find  objects ::TrackRateNames::$name -class TrackRateComponent]] != 0} {
...
proc createRotator {name args} {
   ...
   if { [llength \
      [itcl::find  objects ::RotatorNames::$name -class RotatorComponent]] != 0} {
...
proc createGuide {name args} {
   ...
   if { [llength \
      [itcl::find  objects ::GuideNames::$name -class GuideComponent]] != 0} {
...
proc createCosys {name args} {
   ...
   if { [llength \
      [itcl::find  objects ::CosysNames::$name -class CosysComponent]] != 0} {
